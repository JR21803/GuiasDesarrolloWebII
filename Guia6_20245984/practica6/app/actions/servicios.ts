...
// Esquema de validación para el formulario de serviclo.
//z.coerce.number() convierte el string del formularto a número antes de validar.
...
// Crea on nuevo servicio en la base de datos.
// estado Previo es requerido por useActionState pero no se utiliza en esta función.
export async function crearServicio(_estadoPrevio: any, formData: FormData) {
    ...
    // St la validación falla, se retorna el objeto de errores al componente.
    ...
    // redtrect debe llamarse fuera del try/catch porque lanza una excepción internamente.
    revalidatePath("/servicios");
    redirect("/servicios");
}

// Elimina un servicio por ID.
// Retorna un objeto de resultado para que el componente pueda mostrar un error st falla.
